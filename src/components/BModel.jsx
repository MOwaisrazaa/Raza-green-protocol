import img1 from "../assets/BModelImgs/img-1.png"
import img2 from "../assets/BModelImgs/img-2.png"
import img3 from "../assets/BModelImgs/img-3.png"
import img4 from "../assets/BModelImgs/img-4.png"
import img5 from "../assets/BModelImgs/img-5.png"

const BusinessModel = () => {
  return (
    <div>
        <section className="mt-[60px] lg:mt-[150px] w-[90%] m-auto md:w-[80%] mb-[60px]" id="businessModel">
            <h2 className="text-3xl font-bold text-green-600 md:text-4xl lg:text-5xl">BusinessModel</h2>
